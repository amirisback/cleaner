...
import kotlinx.android.synthetic.main.content_item_cpu_cooler.view.*
...
class CPUCoolerViewAdapter(private val apps: List<Apps>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.content_item_cpu_cooler, parent, false)
